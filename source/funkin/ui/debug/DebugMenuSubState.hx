...
class DebugMenuSubState extends MusicBeatSubState
{
  ...
  override function create():Void
  {
    ...
    var menuBG = new FlxSprite().loadGraphic(
    ...
    /*
     * MUSIC EDITOR REMOVED
     *
     * MusicEditorState does not exist in this project.
     *
     * The old code was:
     *
  ...
  function switchToState(
    stateFactory:Void->flixel.FlxState
  ):Void
  {
    FlxTransitionableState.skipNextTransIn = true;
  ...
  {
    switchToState(
      () -> new funkin.ui.charSelect.CharSelectSubState()
    );
  }
  ...
  {
    openSubState(
      new funkin.ui.transition.stickers.StickerSubState({
      })
    );
  }
  ...
  {
    switchToState(
      () -> new funkin.ui.modmenu.ModMenuState()
    );
  }
  ...
  /*
   * MusicEditorState intentionally removed.
   *
   * The class does not exist in the current source tree,
   * so there is no openMusicEditor() function here.
   */
